...
import { Calendar, Users, FileText, Edit, Trash2, Github, Shield } from 'lucide-react';
import { Project } from '../types';
import { useProject } from '../context/ProjectContext';
import AuthConfigModal from './AuthConfigModal';
import EditarProjectoPopup from './EditarProjectoPopup';
...
export default function ProjectCard({ project, viewMode }: ProjectCardProps) {
  ...
  const handleAuthConfig = (e: React.MouseEvent) => {
    e.preventDefault();
    e.stopPropagation();
