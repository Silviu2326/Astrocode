      ...
      <div className="fixed inset-0 bg-black bg-opacity-70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-gray-900/80 backdrop-blur-xl border border-gray-700/50 rounded-xl shadow-2xl w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            {/* Botón mejorado para generar con IA */}
            <div className="border-t border-gray-700/50 pt-4">
              <button
                type="button"
                onClick={() => setShowAIPopup(true)} 
                className="w-full p-4 rounded-lg border-2 border-pink-400/50 bg-gradient-to-r from-pink-500/10 to-purple-600/10 text-white hover:from-pink-500/20 hover:to-purple-600/20 hover:border-pink-400 transition-all duration-200"
              >
                <div className="flex items-center justify-center space-x-3">
                  <Sparkles className="h-6 w-6 text-pink-400" />
                  <div>
                    <div className="font-medium text-lg">Generar con IA Avanzada</div>
                    <div className="text-sm text-gray-400">12 métodos diferentes de ideación con IA</div>
                  </div>
                </div>
              </button>
            </div>
