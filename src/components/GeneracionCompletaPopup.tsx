...
const [activeTab, setActiveTab] = useState<'pages' | 'entities' | 'controllers' | 'userstories'>('pages');
          ...
          <>
            ...
            <div className="mb-4">
              <div className="flex border-b border-gray-700">
                ...
                // Add a new tab for user stories
                {generationResult.userStoriesResults && (
                  <button
                  ...
                  >
                    User Stories ({generationResult.totalUserStories})
                  </button>
                )}
              </div>
            </div>
...
{activeTab === 'userstories' && (
  <UserStoriesDisplay 
    userStoriesResults={generationResult.userStoriesResults}
    totalUserStories={generationResult.totalUserStories}
  />
)}
...
// Add the content for the user stories tab
